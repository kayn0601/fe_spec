...
describe('Validate JS configs', () => {
  it('Validate eslint-config-kayn', async () => {
  ...
  it('Validate eslint-config-kayn/es5', async () => {
  ...
  it('Validate eslint-config-kayn/vue', async () => {
  ...
  it('Validate eslint-config-kayn/essential', async () => {
  ...
  it('Validate eslint-config-kayn/essential/es5', async () => {
  ...
  it('Validate eslint-config-kayn/essential/react', async () => {
  ...
  it('Validate eslint-config-kayn/essential/vue', async () => {
  ...
  it('Validate eslint-config-kayn/node', async () => {
