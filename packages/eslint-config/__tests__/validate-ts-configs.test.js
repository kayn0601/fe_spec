...
describe('Validate TS configs', () => {
  it('Validate eslint-config-kayn/typescript', async () => {
  ...
  it('Validate eslint-config-kayn/typescript/vue', async () => {
  ...
  it('Validate eslint-config-kayn/essential/typescript', async () => {
  ...
  it('Validate eslint-config-kayn/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-kayn/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-kayn/typescript/node', async () => {
